...
alter table bench alter column vars set not null;
alter table deadlift alter column vars set not null;
alter table squat alter column vars set not null;
alter table overhead_press alter column vars set not null;
alter table bicep alter column vars set not null;
alter table tricep alter column vars set not null;
alter table grip alter column vars set not null;
alter table lunge alter column vars set not null;
alter table calf alter column vars set not null;
alter table row alter column vars set not null;
alter table shrug alter column vars set not null;
alter table pull_up alter column vars set not null;
alter table push_up alter column vars set not null;
alter table dip alter column vars set not null;
alter table abs alter column vars set not null;
alter table lateral_raise alter column vars set not null;
alter table good_morning alter column vars set not null;
alter table face_pull alter column vars set not null;
alter table hip_thrust alter column vars set not null;
alter table hip_abduction alter column vars set not null;
alter table adductors alter column vars set not null;
alter table reverse_flies alter column vars set not null;
alter table rotator_cuff alter column vars set not null;
alter table pull_over alter column vars set not null;
alter table neck alter column vars set not null;
alter table nordic alter column vars set not null;
alter table reverse_nordic alter column vars set not null;
alter table leg_curl alter column vars set not null;
alter table flies alter column vars set not null;
alter table back_extension alter column vars set not null;
